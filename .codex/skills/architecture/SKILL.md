...
- Do not pass concrete component instances from route controllers into views as generic slots. Route controllers should pass data, state, and handlers; views compose feature components into layout slots such as header, main, and footer.
