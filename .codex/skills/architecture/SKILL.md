...
- Keep `src/routes/Root.tsx` as the root route controller for auth, data, editor, and mobile shell state; extract route-local view or layout pieces only when they remove meaningful render or layout complexity.
