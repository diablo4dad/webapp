...
function MobileMenu({ onNavigate, onAuth, currentUser, onLogout }: Props) {
    return (
        <div className={styles.MobileMenu}>
            <button className={styles.MobileMenuLink}
                    onClick={() => onNavigate(ContentType.LEDGER, MasterGroup.GENERAL)}>Essential Collection
            </button>
            <button className={styles.MobileMenuLink}
                    onClick={() => onNavigate(ContentType.LEDGER, MasterGroup.SEASONS)}>Seasons
            </button>
            <button className={styles.MobileMenuLink}
                    onClick={() => onNavigate(ContentType.LEDGER, MasterGroup.SHOP_ITEMS)}>Tejal's Shop
            </button>
            <button className={styles.MobileMenuLink}
                    onClick={() => onNavigate(ContentType.LEDGER, MasterGroup.PROMOTIONAL)}>Promotion
            </button>
