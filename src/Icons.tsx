...
function Discord({ useCssColour = false }: Props) {
    return (
        <svg stroke="currentColor" fill={ useCssColour ? "currentColor" : "#7289da"} strokeWidth="0" viewBox="0 0 640 512"
             xmlns="http://www.w3.org/2000/svg">
            <path
...
export {Gear, Currency, Tick, TickCircle, Discord, BattleNet, Hamburger, Close, Google, ChevronRight}
