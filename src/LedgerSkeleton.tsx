...
function LedgerSkeleton({ view, numItems = 3 }: Props) {
    return (
        <div className={styles.Ledger + ' ' + (view === 'card' ? styles.LedgerCards : '')}>
            <div className={styles.LedgerHeader}>
                <div className={styles.LedgerTitle + ' ' + styles.LedgerHeadingPlaceholder}>Loading...</div>
            ...
            {new Array(numItems).fill(0).map((_, k) =>
                <div className={styles.Item} key={k}>
                    <img className={styles.ItemImage + ' ' + styles.ItemImagePlaceholder} src={imgfill}/>
                    <div className={styles.ItemInfo}>
                        <div className={styles.ItemName + ' ' + styles.ItemNamePlaceholder}>Loading...</div>
                        <div className={styles.ItemName + ' ' + styles.ItemNamePlaceholder}>Loading...</div>
